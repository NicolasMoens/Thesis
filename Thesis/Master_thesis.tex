...
\vspace{-\parskip}
\flushleft
\fontsize{40}{42}\selectfont \textcolor{bluetitle}{Time Dependent Radiation Hydrodynamics in Stellar Winds and Atmospheres}\\[1.5mm]
\fontsize{20}{22}\selectfont mo' code, mo' problems
\end{textblock}
%
